...
const UpdatePost = () => {
  ...
  return (
    <Container className="p-3 mx-auto min-vh-100">
      <h1 className="text-center fs-3 my-4 fw-semibold">Update post</h1>
      ...
      <form className="d-flex flex-column gap-4" onSubmit={handleSubmit}>
        <div className="d-flex">
          ...
          <CategorySelect className='form-select' name="" id="" onChange={(e) => setFormData({...formData, category: e.target.value})} value={formData.category}>
        ...
        <button type="submit" className='btn btn-success p-2 mt-5'>Update post</button>
        {publishError && 
